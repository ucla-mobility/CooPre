...
def main():
    ...
    for class_name in opencood.data_utils.SUPER_CLASS_MAP.keys():
        ...
        result_stat_short[class_name] = {}
        result_stat_middle[class_name] = {}
        result_stat_long[class_name] = {}
        for iou_threshold in [0.3, 0.5, 0.7]:
            result_stat[class_name][iou_threshold] = \
                {'tp': [], 'fp': [], 'gt': 0}
            result_stat_short[class_name][iou_threshold] = \
                {'tp': [], 'fp': [], 'gt': 0}
            result_stat_middle[class_name][iou_threshold] = \
                {'tp': [], 'fp': [], 'gt': 0}
            result_stat_long[class_name][iou_threshold] = \
                {'tp': [], 'fp': [], 'gt': 0}
